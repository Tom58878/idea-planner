module.exports = async (req, res) => {
  ...
  if (isBalanced) {
    objectiveInstruction = "Répartis et équilibre les objectifs sur l'ensemble des cartes de manière variée parmi : 'Éducation / Expertise', 'Storytelling / Confidence', 'Vente / Conversion', 'Viralité / Engagement'.";
  } else {
    objectiveInstruction = `RÈGLE ABSOLUE : L'objectif de TOUTES les cartes générées DOIT ÊTRE STRICTEMENT ET UNIQUEMENT "${objective}".`;
  }
